import { EntityWallCreateInfo } from 'src/entity/wall/EntityWall';
    ...
    private OnPointerUp(event: PointerEvent): void {
        if (WhoaFramework.PointerButton.LEFT == event.button) {
            if (CreateStatus.START == this.status_) {
                ...
                // const mesh = WhoaScene.MeshBuilder.CreateDisc(uuid(), {
                ...
                // mesh.position = new WhoaMath.WhoaMath.WhoaMath.Vector3(this.start_.x, this.start_.y, this.wall_height_);
